    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('1', 'doctor'), ('2', 'patient'), ('3', 'super_user')], max_length=6, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medical_history', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.medicalhistory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_created_by', to=settings.AUTH_USER_MODEL)),
                ('education', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='education_related', to='users.education')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(app_label)s_%(class)s_updated_by', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='admin_education', to='users.doctor')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='doctor',
            name='education',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.education'),
        ),
        migrations.AddField(
            model_name='doctor',
            name='role',
        ...
        migrations.AddField(
            model_name='doctor',
            name='training',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.doctortraininghistory'),
        ),
        migrations.AddField(
            model_name='doctor',
            name='user',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.doctorworkexperience'),
        ),
    ]
